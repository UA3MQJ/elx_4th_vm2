defmodule E4vm.Words.Stack do
  ...
  def add_core_words(%E4vm{} = vm) do
    vm
    |> E4vm.add_core_word("drop",      __MODULE__, :drop,          false)
    |> E4vm.add_core_word("swap",      __MODULE__, :swap,          false)
    |> E4vm.add_core_word("dup",       __MODULE__, :dup,           false)
    |> E4vm.add_core_word("over",      __MODULE__, :over,          false)
    |> E4vm.add_core_word("rot",       __MODULE__, :rot,           false)
    |> E4vm.add_core_word("nrot",      __MODULE__, :nrot,          false)
  end
