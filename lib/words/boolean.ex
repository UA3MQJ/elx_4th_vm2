defmodule E4vm.Words.Boolean do
  ...
  def add_core_words(%E4vm{} = vm) do
    vm
    |> E4vm.add_core_word("true",      __MODULE__, :bool_true,        false)
    |> E4vm.add_core_word("false",     __MODULE__, :bool_false,       false)
    |> E4vm.add_core_word("and",       __MODULE__, :bool_and,         false)
    |> E4vm.add_core_word("or",        __MODULE__, :bool_or,          false)
    |> E4vm.add_core_word("xor",       __MODULE__, :bool_xor,         false)
    |> E4vm.add_core_word("not",       __MODULE__, :bool_not,         false)
    |> E4vm.add_core_word("invert",    __MODULE__, :bool_invert,      false)
    |> E4vm.add_core_word("=",         __MODULE__, :bool_eql,         false)
    |> E4vm.add_core_word("<>",        __MODULE__, :bool_not_eql,     false)
    |> E4vm.add_core_word("<",         __MODULE__, :bool_less,        false)
    |> E4vm.add_core_word(">",         __MODULE__, :bool_greater,     false)
    |> E4vm.add_core_word("<=",        __MODULE__, :bool_less_eql,    false)
    |> E4vm.add_core_word(">=",        __MODULE__, :bool_greater_eql, false)
  end
