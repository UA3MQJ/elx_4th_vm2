defmodule E4vm.Words.Mem do
  ...
  def add_core_words(%E4vm{} = vm) do
    vm
    |> E4vm.add_core_word("!",         __MODULE__, :write_mem,       false)
    |> E4vm.add_core_word("@",         __MODULE__, :read_mem,        false)
    |> E4vm.add_core_word("variable",  __MODULE__, :variable,        false)
    |> E4vm.add_core_word("constant",  __MODULE__, :constant,        false)
  end
  ...
  def constant(%E4vm{} = vm) do
    ...
    case E4vm.read_word(vm) do
      {vm, :end} ->
        ...
        vm
      {new_vm, word} ->
        # IO.inspect(label: ">>>> constant WORD #{word}")
